                    ...
                    <ScrollView style={{width: '100%', zIndex: this.props.zIndex}} nestedScrollEnabled={true}>
                        {
                            items.length > 0 ? items.map((item, index) => (
                                ...
                                >
                                    ...
                                    {
                                        multiple && this.state.choice.findIndex(i => i.label === item.label && i.value === item.value) > -1  ? ( this.props.customTickIcon())  : multiple && (
                                            this.props.customUnTickIcon()
                                        )
                                    }
                                </TouchableOpacity>
                            )) : (
...
DropDownPicker.defaultProps = {
    ...
    customUnTickIcon: () => <Feather name="check" size={15} />,
    zIndex: 5000,
    disabled: false,
    searchable: false,
